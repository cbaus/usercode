...
void Show(TH1D* a,TH1D* b,TH1D* c,TH1D* d, TH1D* e, TH1D* f, TH1D* g, string type);
...
void makePlots()
{
  ...
  Show(aa,aa2,bb,cc,dd,ee,ff,string("double"));
